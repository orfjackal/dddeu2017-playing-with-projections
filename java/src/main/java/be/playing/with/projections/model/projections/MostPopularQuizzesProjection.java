 ...
 */
public class MostPopularQuizzesProjection implements Projection<List<String>> {
  ...
  public List<String> project(List<Event> events) {
    ...
    for (Event event : events) {
      ...
      if (event.getType() == EventType.GAME_WAS_OPENED) {
        String quizId = event.getPayload().get("quiz_id");
  ...
  public String buildResultMessage(List<String> projectResult) {
    return projectResult + " were the most popular quizzes";
  }
}
